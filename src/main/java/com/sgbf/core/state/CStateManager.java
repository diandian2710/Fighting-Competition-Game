...
public class CStateManager {
     ...
     * (i.e. CState.getId() )
     */
    private HashMap<String, CState> states;

    /**
     * The queue of states waiting to be written
     */
    private LinkedList<CState> stateQueue;

    /**
     * The current set of state listeners
     */
    private LinkedList<IStateListener> listeners;
    ...
    private CStateManager() {
        states = new HashMap<String, CState>();
        stateQueue = new LinkedList<CState>();
        listeners = new LinkedList<IStateListener>();
        idle = true;
    }
