...
CBattleState extends CState {
     ...
     * The gladiators
     */
    private LinkedList<CGladiator> gladiators;
    ...
    public CGladiator getGladiator(int i) {
        return gladiators.get(i);
    }
     ...
     * CONSTRUCTOR
     */
    public CBattleState(LinkedList<CGladiator> gladiators) {
        this.gladiators = new LinkedList<CGladiator>();
